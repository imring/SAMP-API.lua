...
local CTextDraw_constructor = ffi.cast('void(__thiscall*)(SCTextDraw*, STransmit*, const char*)', 0xB2E50)
local CTextDraw_destructor = ffi.cast('void(__thiscall*)(SCTextDraw*)', 0xB26C0)
...
local SCTextDraw_mt = {
    SetText = ffi.cast('void(__thiscall*)(SCTextDraw*, const char*)', sampapi.GetAddress(0xB26D0)),
    Draw = ffi.cast('void(__thiscall*)(SCTextDraw*)', sampapi.GetAddress(0xB2BF0)),
}

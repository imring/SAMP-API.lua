...
local CLicensePlate_constructor = ffi.cast('void(__thiscall*)(SCLicensePlate*, IDirect3DDevice9*)', 0x6D240)
local CLicensePlate_destructor = ffi.cast('void(__thiscall*)(SCLicensePlate*)', 0x6D270)
...
local SCLicensePlate_mt = {
    OnLostDevice = ffi.cast('void(__thiscall*)(SCLicensePlate*)', sampapi.GetAddress(0x6D040)),
    OnResetDevice = ffi.cast('void(__thiscall*)(SCLicensePlate*)', sampapi.GetAddress(0x6D090)),
    Create = ffi.cast('IDirect3DTexture9 * (__thiscall*)(SCLicensePlate*, const char*)', sampapi.GetAddress(0x6D110)),
}
mt.set_handler('struct SCLicensePlate', '__index', SCLicensePlate_mt)

local function RefLicensePlateManager() return ffi.cast('SCLicensePlate**', sampapi.GetAddress(0x26E8E8))[0] end

...
local CHelpDialog_constructor = ffi.cast('void(__thiscall*)(SCHelpDialog*, IDirect3DDevice9*)', 0x6B3B0)
...
local SCHelpDialog_mt = {
    Show = ffi.cast('void(__thiscall*)(SCHelpDialog*)', sampapi.GetAddress(0x6B3C0)),
}
mt.set_handler('struct SCHelpDialog', '__index', SCHelpDialog_mt)

local function RefHelpDialog() return ffi.cast('SCHelpDialog**', sampapi.GetAddress(0x26E8BC))[0] end

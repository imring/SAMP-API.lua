...
local CNetStats_constructor = ffi.cast('void(__thiscall*)(SCNetStats*, IDirect3DDevice9*)', 0x605C0)
...
local SCNetStats_mt = {
    Draw = ffi.cast('void(__thiscall*)(SCNetStats*)', sampapi.GetAddress(0x605F0)),
}
mt.set_handler('struct SCNetStats', '__index', SCNetStats_mt)

local function RefNetStats() return ffi.cast('SCNetStats**', sampapi.GetAddress(0x26E8B4))[0] end

...
local SCLabelPool_mt = {
    Create = ffi.cast('void(__thiscall*)(SCLabelPool*, ID, const char*, D3DCOLOR, SCVector, float, bool, ID, ID)', sampapi.GetAddress(0x11C0)),
    Delete = ffi.cast('BOOL(__thiscall*)(SCLabelPool*, ID)', sampapi.GetAddress(0x12D0)),
    Draw = ffi.cast('void(__thiscall*)(SCLabelPool*)', sampapi.GetAddress(0x1340)),
}

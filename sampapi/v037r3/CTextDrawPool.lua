...
local CTextDrawPool_constructor = ffi.cast('void(__thiscall*)(SCTextDrawPool*)', 0x1E050)
local CTextDrawPool_destructor = ffi.cast('void(__thiscall*)(SCTextDrawPool*)', 0x1E180)
...
local SCTextDrawPool_mt = {
    Delete = ffi.cast('void(__thiscall*)(SCTextDrawPool*, ID)', sampapi.GetAddress(0x1E0A0)),
    Draw = ffi.cast('void(__thiscall*)(SCTextDrawPool*)', sampapi.GetAddress(0x1E0E0)),
    Create = ffi.cast('SCTextDraw * (__thiscall*)(SCTextDrawPool*, int, STransmit*, const char*)', sampapi.GetAddress(0x1E1C0)),
}

...
local CSrvNetStats_constructor = ffi.cast('void(__thiscall*)(SCSrvNetStats*, IDirect3DDevice9*)', 0x70B30)
...
local SCSrvNetStats_mt = {
    Draw = ffi.cast('void(__thiscall*)(SCSrvNetStats*)', sampapi.GetAddress(0x70B70)),
}
mt.set_handler('struct SCSrvNetStats', '__index', SCSrvNetStats_mt)

local function RefServerNetStatistics() return ffi.cast('SCSrvNetStats**', sampapi.GetAddress(0x26E8B8))[0] end

...
local SCHelpDialog_mt = {
    Show = ffi.cast('void(__thiscall*)(SCHelpDialog*)', sampapi.GetAddress(0x67450)),
}
mt.set_handler('struct SCHelpDialog', '__index', SCHelpDialog_mt)

local function RefHelpDialog() return ffi.cast('SCHelpDialog**', sampapi.GetAddress(0x21A0D8))[0] end

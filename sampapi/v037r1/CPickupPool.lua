...
local SCPickupPool_mt = {
    Create = ffi.cast('void(__thiscall*)(SCPickupPool*, SPickup*, int)', sampapi.GetAddress(0xFDC0)),
    CreateWeapon = ffi.cast('void(__thiscall*)(SCPickupPool*, int, SCVector, int, ID)', sampapi.GetAddress(0xFCD0)),
    Delete = ffi.cast('void(__thiscall*)(SCPickupPool*, int)', sampapi.GetAddress(0xFE70)),
    DeleteWeapon = ffi.cast('void(__thiscall*)(SCPickupPool*, ID)', sampapi.GetAddress(0xFED0)),
    GetIndex = ffi.cast('int(__thiscall*)(SCPickupPool*, int)', sampapi.GetAddress(0xFF30)),
    SendNotification = ffi.cast('void(__thiscall*)(SCPickupPool*, int)', sampapi.GetAddress(0xFF90)),
    Process = ffi.cast('void(__thiscall*)(SCPickupPool*)', sampapi.GetAddress(0x10070)),
}

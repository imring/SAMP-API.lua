...
local GetMaxSizeChar = ffi.cast('const char*(__cdecl*)()', sampapi.GetAddress(0x6D9B0))

local SCObjectEdit_mt = {
    WorldToScreen = ffi.cast('float(__thiscall*)(SCObjectEdit*, SCVector*, float*)', sampapi.GetAddress(0x6D640)),
    WorldToScreen = ffi.cast('float(__thiscall*)(SCObjectEdit*, SCVector*, float*)', sampapi.GetAddress(0x6D640)),
    RenderAxes = ffi.cast('int(__thiscall*)(SCObjectEdit*, SCMatrix*, float)', sampapi.GetAddress(0x6D740)),
    GetRenderChar = ffi.cast('const char*(__thiscall*)(SCObjectEdit*, BOOL)', sampapi.GetAddress(0x6D9C0)),
    TryChangeProcessType = ffi.cast('void(__thiscall*)(SCObjectEdit*)', sampapi.GetAddress(0x6DAC0)),
    SetEditMode = ffi.cast('void(__thiscall*)(SCObjectEdit*, SObjectEditMode)', sampapi.GetAddress(0x6DC10)),
    ResetMousePos = ffi.cast('void(__thiscall*)(SCObjectEdit*)', sampapi.GetAddress(0x6DDE0)),
    EnterEditObject = ffi.cast('void(__thiscall*)(SCObjectEdit*, ID, BOOL)', sampapi.GetAddress(0x6DE40)),
    SendEditEndNotification = ffi.cast('void(__thiscall*)(SCObjectEdit*, int)', sampapi.GetAddress(0x6E2D0)),
    SendAttachedEditEndNotification = ffi.cast('void(__thiscall*)(SCObjectEdit*, int)', sampapi.GetAddress(0x6E4E0)),

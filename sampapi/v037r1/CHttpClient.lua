...
local SCHttpClient_mt = {
    GetHeaderValue = ffi.cast('bool(__thiscall*)(SCHttpClient*, const char*, char*, int)', sampapi.GetAddress(0x23A0)),
    InitializeRequest = ffi.cast('void(__thiscall*)(SCHttpClient*, int, const char*, const char*, const char*)', sampapi.GetAddress(0x24A0)),
    HandleEntity = ffi.cast('void(__thiscall*)(SCHttpClient*)', sampapi.GetAddress(0x2670)),
    Connect = ffi.cast('bool(__thiscall*)(SCHttpClient*, const char*, int)', sampapi.GetAddress(0x2990)),
    Process = ffi.cast('void(__thiscall*)(SCHttpClient*)', sampapi.GetAddress(0x2A50)),
    Disconnect = ffi.cast('void(__thiscall*)(SCHttpClient*)', sampapi.GetAddress(0x2430)),
    ProcessUrl = ffi.cast('SErrorCode(__thiscall*)(SCHttpClient*, int, const char*, const char*, const char*)', sampapi.GetAddress(0x2C30)),
    Send = ffi.cast('bool(__thiscall*)(SCHttpClient*, const char*)', sampapi.GetAddress(0x2440)),
    Receive = ffi.cast('int(__thiscall*)(SCHttpClient*, char*, int)', sampapi.GetAddress(0x2480)),
}

...
local SCChatBubble_mt = {
    Add = ffi.cast('void(__thiscall*)(SCChatBubble*, ID, const char*, D3DCOLOR, float, int)', sampapi.GetAddress(0x63250)),
    Draw = ffi.cast('void(__thiscall*)(SCChatBubble*)', sampapi.GetAddress(0x63310)),
}
mt.set_handler('struct SCChatBubble', '__index', SCChatBubble_mt)

local function RefChatBubble() return ffi.cast('SCChatBubble**', sampapi.GetAddress(0x21A0DC))[0] end

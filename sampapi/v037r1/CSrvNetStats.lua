...
local SCSrvNetStats_mt = {
    Draw = ffi.cast('void(__thiscall*)(SCSrvNetStats*)', sampapi.GetAddress(0x6CC80)),
}
mt.set_handler('struct SCSrvNetStats', '__index', SCSrvNetStats_mt)

local function RefServerNetStatistics() return ffi.cast('SCSrvNetStats**', sampapi.GetAddress(0x21A0D4))[0] end

...
local SCNetStats_mt = {
    Draw = ffi.cast('void(__thiscall*)(SCNetStats*)', sampapi.GetAddress(0x5D250)),
}
mt.set_handler('struct SCNetStats', '__index', SCNetStats_mt)

local function RefNetStats() return ffi.cast('SCNetStats**', sampapi.GetAddress(0x21A0D0))[0] end

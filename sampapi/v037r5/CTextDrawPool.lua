...
local CTextDrawPool_constructor = ffi.cast('void(__thiscall*)(SCTextDrawPool*)', 0x1E7A0)
local CTextDrawPool_destructor = ffi.cast('void(__thiscall*)(SCTextDrawPool*)', 0x1E8D0)
...
local SCTextDrawPool_mt = {
    Delete = ffi.cast('void(__thiscall*)(SCTextDrawPool*, ID)', sampapi.GetAddress(0x1E7F0)),
    Draw = ffi.cast('void(__thiscall*)(SCTextDrawPool*)', sampapi.GetAddress(0x1E830)),
    Create = ffi.cast('SCTextDraw * (__thiscall*)(SCTextDrawPool*, int, STransmit*, const char*)', sampapi.GetAddress(0x1E910)),
}

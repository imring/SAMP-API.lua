...
local CPickupPool_constructor = ffi.cast('void(__thiscall*)(SCPickupPool*)', 0x84A0)
local CPickupPool_destructor = ffi.cast('void(__thiscall*)(SCPickupPool*)', 0x13410)
...
local SCPickupPool_mt = {
    ...
    CreateWeapon = ffi.cast('void(__thiscall*)(SCPickupPool*, int, SCVector, int, ID)', sampapi.GetAddress(0x13180)),
    Delete = ffi.cast('void(__thiscall*)(SCPickupPool*, int)', sampapi.GetAddress(0x13320)),
    DeleteWeapon = ffi.cast('void(__thiscall*)(SCPickupPool*, ID)', sampapi.GetAddress(0x13380)),
    GetIndex = ffi.cast('int(__thiscall*)(SCPickupPool*, int)', sampapi.GetAddress(0x133E0)),
    SendNotification = ffi.cast('void(__thiscall*)(SCPickupPool*, int)', sampapi.GetAddress(0x13440)),
    Process = ffi.cast('void(__thiscall*)(SCPickupPool*)', sampapi.GetAddress(0x13520)),
}

...
local CChatBubble_constructor = ffi.cast('void(__thiscall*)(SCChatBubble*)', 0x66DE0)
...
local SCChatBubble_mt = {
    Add = ffi.cast('void(__thiscall*)(SCChatBubble*, ID, const char*, D3DCOLOR, float, int)', sampapi.GetAddress(0x66E10)),
    Draw = ffi.cast('void(__thiscall*)(SCChatBubble*)', sampapi.GetAddress(0x66ED0)),
}
mt.set_handler('struct SCChatBubble', '__index', SCChatBubble_mt)

local function RefChatBubble() return ffi.cast('SCChatBubble**', sampapi.GetAddress(0x26EB78))[0] end
